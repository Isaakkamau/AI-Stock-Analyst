...
#st.title('AI Stock Analysis Agent (US MARKET)')

st.markdown("""
### AI Stock Analysis Agent

This app leverages Langchain, OpenBB, and Anthropic's Claude 3 Opus, and GPT4 to create a powerful AI-powered stock analysis agent. It combines fundamental analysis tools to assess financial health and technical analysis for identifying market trends. Users can access critical financial metrics, stock ratios, and advanced technical indicators to make informed trading decisions.

For more details, visit [this project's page](https://sethhobson.com/2024/04/expanding-the-ai-stock-analysis-agent-with-fundamental-and-technical-tools/).
""")
